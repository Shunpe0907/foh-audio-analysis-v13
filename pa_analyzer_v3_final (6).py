...
class InstrumentAnalyzer:
    ...
    def _analyze_snare(self, audio, spectrum, freqs, base_analysis):
        """スネア超詳細解析"""
    ...
    def _analyze_bass(self, audio, spectrum, freqs, base_analysis):
        """ベース超詳細解析"""
    ...
    def _analyze_hihat(self, audio, spectrum, freqs, base_analysis):
        """ハイハット詳細解析"""
    ...
    def _analyze_tom(self, audio, spectrum, freqs, base_analysis):
        """タム詳細解析"""
    ...
    def _analyze_guitar(self, name, audio, spectrum, freqs, base_analysis):
        """ギター詳細解析"""
    ...
    def _analyze_keys(self, name, audio, spectrum, freqs, base_analysis):
        """キーボード/シンセ詳細解析"""
